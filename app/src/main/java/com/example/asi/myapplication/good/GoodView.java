 ...
 */
package com.example.asi.myapplication.good;
...
import com.example.asi.myapplication.R;
...
public class GoodView extends PopupWindow implements IGoodView  {
    ...
    private void initView() {
        ...
        mGood.measure(w, h);
        setWidth(mGood.getMeasuredWidth()*2);
        setHeight(mDistance + mGood.getMeasuredHeight());
        setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        setFocusable(false);
        setTouchable(false);
        setOutsideTouchable(false);
        setImage(R.mipmap.good_checked);
    ...
    public void setImage(Drawable drawable) {
        if (drawable == null) {
            ...
            mGood.setImageDrawable(drawable);
    ...
    private AnimationSet createAnimation() {
        ...
        ScaleAnimation scaleAnimation = new ScaleAnimation(1.0f, 1.4f, 1f, 1.4f);
